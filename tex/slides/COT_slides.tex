...
\begin{frame}{Numerical Model Results: Feed $\theta_{ut},\theta_{rt}$ from Data}
	\begin{figure}
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.32]{\modelplots/AgrEmpl_data.pdf}
			\caption{Rural Employment}
			\label{fig:sub1}
		\end{subfigure}\hskip 1mm%
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.32]{\modelplots/Expshares.pdf}
			\label{fig:sub2}
			\caption{Spending Shares}
		\end{subfigure}
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.32]{\modelplots/CitySize_data.pdf}
			\label{fig:sub2}
		...
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.32]{\modelplots/AvgDens_data_levels.pdf}
			\caption{Avg Urban Density}
			\label{fig:sub1}
		\end{subfigure}\hskip 1mm%
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.32]{\modelplots/UrbDens.pdf}
			\label{fig:sub2}
			\caption{Relative densities}
		\end{subfigure}
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.32]{\modelplots/DecDensity.pdf}
			\label{fig:sub2}
...
\begin{frame}{Numerical Model Results}
	...
	\begin{figure}
		\begin{subfigure}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.5]{\modelplots/HouseIndex1990.pdf}
			\caption{House Price index (1990=100)}
		\end{subfigure}\hfill
		\begin{subfigure}[t]{0.5\textwidth}
			\centering
			\includegraphics[scale=0.5]{\modelplots/WealthValues.pdf}
