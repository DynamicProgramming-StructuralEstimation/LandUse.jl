...
\begin{frame}{Baseline Model Results}
	\begin{figure}
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.3]{\modelplots/AgrEmpl_data_2901.pdf}
			\caption{Rural Employment}
			\label{fig:sub1}
		\end{subfigure}\hskip 1mm%
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.3]{\modelplots/AgrPrice_data_2901.pdf}
			\label{fig:sub2}
			\caption{Relative price}
		\end{subfigure}
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.3]{\modelplots/CitySize_2901.pdf}
			\label{fig:sub2}
			\caption{city size}
		\end{subfigure}
		...
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.3]{\modelplots/UrbDens_2901.pdf}
			\caption{Urban densities}
			\label{fig:sub1}
		\end{subfigure}\hskip 1mm%
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.3]{\modelplots/WealthValues_2901.pdf}
			\label{fig:sub2}
			\caption{Wealth / Income}
		\end{subfigure}
		\begin{subfigure}[t]{0.32\textwidth}
			\centering
			\includegraphics[scale=0.3]{\modelplots/HouseIndex_2901.pdf}
			\label{fig:sub2}
			\caption{Housing Price}
		\end{subfigure}
	\end{figure}
\end{frame}

\begin{frame}{Counterfactual: Only Rural Growth}
\begin{figure}
...
\begin{frame}{Counterfactual: Only Urban Growth}
	\begin{figure}
...
\begin{frame}{\emph{French Top 20}}
	...
	\begin{adjustbox}{center}
		\includegraphics[width=0.8\textwidth]{\modelplots/k20-density3D-2020.pdf}
	\end{adjustbox}
