...
\smallskip
\bi
\item Simple Version to generate intuition
\ei

\smallskip
\bi
\item Extended Quantitative Model to Match French data since 1840
\ei
...
\item \hyperlink{GHSL}{\beamergotobutton{More details please!}}
\end{midi}
...
\includegraphics[width=0.4\textwidth]{\imgs/paris-horses.jpeg}\\
\includegraphics[width=0.4\textwidth]{\imgs/paris-Omnibus.JPG}\\
\includegraphics[width=0.4\textwidth]{\imgs/paris-renault.jpg}
...
\begin{frame}[label=eqm]{Equilibrium}
	...
	\begin{midi}
		\item Land developers buy land and numeraire good to provide residential floorspace. \hyperlink{landdevelopers}{\beamergotobutton{Details!}}
	...
	\begin{columns}
		...
		\begin{column}{\textwidth}
			\begin{figure}
				% \centering
				% \makebox[0pt][c]{%
				% \begin{adjustbox}{center,figure}
					% \adjustbox{center,figure}{
					\centering
					\parbox{\textwidth}{\lineskip=0pt
						
						\begin{subfigure}{0.29\textwidth}
							\includegraphics[width=\linewidth]{\modelplots/AgrEmpl_baseline.pdf}
							\caption{Rural Employment share.\label{fig:cf-city-comp-eta}}
						\end{subfigure}\hfill%
						\visible<2->{\begin{subfigure}{0.29\textwidth}
							\includegraphics[width=\linewidth]{\modelplots/Expshares_baseline.pdf}
							\caption{Expenditure Shares.\label{fig:cf-udens-comp-eta}}
						\end{subfigure}}\hfill%
						\visible<3->{\begin{subfigure}{0.29\textwidth}
							\includegraphics[width=\linewidth]{\modelplots/AgrPrice_baseline.pdf}
							\caption{$r$-price\label{fig:cf-ctrdens-comp-eta}}
						\end{subfigure}}
						
						\visible<4->{\begin{subfigure}{0.29\textwidth}
							\includegraphics[width=\linewidth]{\modelplots/CitySize_baseline.pdf}
							\caption{City size (Index, 1840=1)\label{fig:cf-fringedens-comp-eta}}
						\end{subfigure}}\hfill%
						\visible<5->{\begin{subfigure}{0.29\textwidth}
							\includegraphics[width=\linewidth]{\modelplots/UrbDens_baseline.pdf}
							\caption{Densities (Index, 1840=1)\label{fig:cf-densgrad-comp-eta}}
						\end{subfigure}}\hfill%
						\visible<6->{\begin{subfigure}{0.29\textwidth}
							\includegraphics[width=\linewidth]{\modelplots/LandRents_baseline.pdf}
							\caption{Land rents (\%).\label{fig:cf-housingprice-comp-eta}}
						\end{subfigure}}
					}
				% \end{adjustbox}
...
\begin{figure}
	...
	\end{subfigure}
	\hfill
	\visible<2->{\begin{subfigure}[t]{0.32\textwidth}
		\begin{centering}
	...
	\end{subfigure}}
	\hfill
	\visible<3->{\begin{subfigure}[t]{0.32\textwidth}
		\begin{centering}
...
\begin{frame}[label=param]{Full Quantitative Model and Parameterization}
	\begin{mide}
		...
		\item We use individual commuting data to directly calibrate the $\tau$ parameters. \hyperlink{tau}{\beamergotobutton{How?}}
...
\begin{columns}
	\begin{column}{0.5\textwidth}
		\includegraphics[width=0.9\textwidth]{\modelplots/CommSpeed_data.pdf}
	\end{column}
	\begin{column}{0.5\textwidth}
		\includegraphics[height=0.4\textwidth]{\imgs/paris-1850.jpg}\includegraphics[height=0.4\textwidth]{\imgs/paris-horses.jpeg}\\
		\includegraphics[width=0.4\textwidth]{\imgs/paris-bastille.jpg}
		\includegraphics[height=0.4\textwidth]{\imgs/paris-renault.jpg}
	\end{column}
\end{columns}
\end{frame}
...
\begin{frame}[label=wealthdist]{Numerical Model Results: Wealth Distribution and House Price}
	...
	\end{figure}
	\hyperlink{AGP}{\beamergotobutton{Agricultural Productivity Gap}}
...
\begin{frame}[label=AGP]{Agricultural Productivity Gap}
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\includegraphics[width=0.9\textwidth]{\modelplots/APG.pdf}
				\caption{Agricultural Productivity Gap}	
			\end{figure}
		\end{column}
	\end{columns}
	\hyperlink{wealthdist}{\beamergotobutton{back}}
...
\begin{frame}[label=GHSL]{GHSL Measurement - Reims \hyperlink{GHSL_measure}{\beamergotobutton{back}}}

	\centering
	\makebox[0pt][c]{%
	\begin{minipage}[h]{0.33\linewidth}
		\includegraphics[height=0.4\textheight]{\screenshots/reims-EM.png}
		\includegraphics[height=0.42\textheight]{\screenshots/reims-1950.png}
		\vfill
	\end{minipage}\hspace{0.02\linewidth}
	\begin{minipage}[h]{0.66\linewidth}
		\includegraphics[height=\textheight]{\dataplots/GHSL-Built-Cut-Reims.pdf}
	...
	% 	\end{column}
	% 	\begin{column}{0.8\textwidth}
	% 			\includegraphics[height=0.8\textheight]{\dataplots/GHSL-Built-Cut-Reims.pdf}
	% 	\end{column}
	% \end{columns}
...
\begin{frame}[label=tau]{Calibration of $\tau$}
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.5\textwidth}
				\includegraphics[width=1.05\textwidth]{\ENL/plots/speed-dist-france-2013.pdf}
		\end{column}
	\end{columns}
	\hyperlink{param}{\beamergotobutton{back}}
