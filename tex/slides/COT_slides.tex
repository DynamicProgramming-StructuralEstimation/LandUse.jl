...
\begin{frame}{Urban Expansion: Competing Theories}
...
\begin{midi}
\item Food subsistence constraint is binding initially. No income left for bigger houses. (No need to commute to large suburban houses.)
...
\begin{frame}{Baseline Model: Empirical Targets}{Work in Progress: Currently collecting density within largest cities to confront with central plot}

\begin{adjustbox}{center}
\includegraphics[width=1.0\textwidth]{\modelplots/issue36-baseline-fit.pdf}
\end{adjustbox}
...
\begin{frame}{Counterfactual 2: High Urban Productivity Growth Only}{Commuting Costs are Declining with Rising Incomes!}

\begin{columns}
\begin{column}{0.3\textwidth}
\begin{midi}
\item Rural employment too high throughout.
\item City density does not fall enough. Why?
\item $\Rightarrow$ Because rural land rents increase!
\end{midi}
\end{column}
\begin{column}{0.7\textwidth}
\begin{adjustbox}{center}
...
\begin{frame}{Counterfactual 3: High Rural Productivity Growth Only}{Commuting Costs are \emph{not} declining (urban income does not rise)!}

\begin{columns}
\begin{column}{0.3\textwidth}
\begin{midi}
\item Rural \emph{push} gets labor allocation right.
\item No urban growth means no fall in commuting cost. 
\item City gets increasingly dense.
\item Spending on housing gets very high.
\end{midi}
\end{column}
\begin{column}{0.7\textwidth}
\begin{adjustbox}{center}
