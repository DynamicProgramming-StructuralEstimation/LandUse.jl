...
function show(io::IO, m::Model)
    ...
    @printf(io,"Region: θu=%06.3f, θr=%06.3f, ϕ=%1.4f, cityarea=%1.4f, area=%1.2f, Lu=%1.3f, Lr=%1.3f, pop=%1.3f, pr=%1.3f",m.θu, m.θr, m.ϕ, cityarea(m), area(m), m.Lu, m.Lr,pop(m),m.pr)
end
